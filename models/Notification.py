...
class Notification:
    ...
    def create_notification_model(self, userId, username, text, createdAt, type):
    ...
    def delete_notification_by_id(self, notificationId):
        notification_collection = db.notifications
        result = notification_collection.delete_one({"_id": ObjectId(notificationId)})
        return result.deleted_count > 0

    def delete_all_notifications_by_userId(self, userId):
        notification_collection = db.notifications
